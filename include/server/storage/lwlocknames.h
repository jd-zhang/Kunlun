...
#define GlobalXidSenderLock (&MainLWLockArray[46].lock)
#define MetadataDDLSyncLock (&MainLWLockArray[47].lock)
#define MetadataLogAppliersLock (&MainLWLockArray[48].lock)
